...
$cutimage= "http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/".$valuen->image;
...
<td style="text-align:right; width:15%"><img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/data/Social%20Icons/IndianRupee.png" style="height:8px; width:8px;"> '.round($shopprodprice).'</td>
<td style="text-align:right; width:15%"><img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/data/Social%20Icons/IndianRupee.png" style="height:8px;width:8px;"> '.round($shopprodprice).'</td>
</tr>';
         ...
         $shopbag.='<tr style="background:#f0f0c3; "><td colspan="4" align="right">Sub-Total : </td><td style="float:right;"><img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/data/Social%20Icons/IndianRupee.png" style="height:8px;width:8px;"> '.round($totalval).'</td></tr>
<tr style="background:#f0f0c3; "><td colspan="4" align="right">Total : </td><td style="float:right;"><img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/data/Social%20Icons/IndianRupee.png" style="height:8px;width:8px;"> '.round($totalval).'</td></tr></tbody></table>'; 
...
foreach ($productcinfos as $result) {
			...
			$this->data['products'][] = array(
				...
				'price'   	 => $price,
				'special' 	 => $special,
				'href'    	 => 'http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/index.php?route=product/product&amp;product_id='.$result['product_id'],
...
$subjectaa ="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/".$subjectaa;
...
<p style="text-align:center;"><span><img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/data/Social%20Icons/IndianRupee.png" style="height:8px;width:8px;"> '.round($pricevali).'</span></p>
...
<a style="color:#FFF !important; text-align:center; cursor:pointer;" href="'.$info['href'].'" class="shopnownbtn"><div style="cursor:pointer;"><button class="mybtnccls" style="height:35px; width:80%; color: #000;border: 2px solid #ccc !important; cursor:pointer;">Shop Now</button></div></a></p>
 ...
 $latestpros.='</tr>
	...
	$changename= ucfirst($domain1);
       ...
       if($abuserid){
	$checkoutnowbtnval='http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/cart?abuserid='.$abuserid; } 
else{$checkoutnowbtnval='http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/';}
//echo 'http://'. $_SERVER['SERVER_NAME']."<br/>" . $_SERVER['REQUEST_URI']; 
/*
$url = "http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/discountmsg.html";
$ch = curl_init();
...
*/
        $message1= htmlentities(file_get_contents("http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/discountmsg.html"));   
...
{
$discountdisn='<img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/data/Social%20Icons/IndianRupee.png" style="height:10px;width:10px;">'.$discountdisn;
              $strn2=str_replace('ndispercent',$discountdisn,$message1);  
}
