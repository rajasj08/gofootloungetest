...
$sql = "SELECT a.order_status_id,a.date_added,a.date_modified,a.order_id,a.email,a.firstname,a.lastname FROM `oc_order` as a where DATE(a.date_added) = DATE_SUB(CURDATE(), INTERVAL 1 DAY)";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {  
		...
		$headers .= 'Content-type: text/html; charset=UTF-8' . "\r\n";
	      ...
	      // if( mail('Pooja_khatri@yahoo.com', 'Email Notification Request Received', $str1, $headers))
	     if( mail($tomail, 'Let’s Stay Connected!', $message1, $headers))
	     {  $count++;} else echo 0;         
