...
class ControllerCheckoutRegister extends Controller {
	...
	public function validate() {
		...
		if (!$json) {					
			...
			if ((utf8_strlen($this->request->post['postcode']) < 6) || (utf8_strlen($this->request->post['postcode']) > 6) || ($this->request->post['postcode'])=='') {
					
				$json['error']['postcode'] = "Post code must be 6 digits!";  
				}     
			...
			if ($country_info) {
				if ($country_info['postcode_required'] && (utf8_strlen($this->request->post['postcode']) < 2) || (utf8_strlen($this->request->post['postcode']) > 10)) {
					$json['error']['postcode'] = "Post code must be 6 digits!";  //$this->language->get('error_postcode');
				}
