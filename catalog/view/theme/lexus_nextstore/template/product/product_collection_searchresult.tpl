<div class="product-list"> 
	<div class="products-block">
		...
		<?php }
		//echo $product['optionname'];echo "<br/>";
 ?>
						...
						<div class="product-cont">
							...
							<div class="action">
								...
								<?php if($product['quantity']<=0) { 
									...
									?>
									<!--<div class="quick-view mailview" id="smailview1" style=""> 
										
											<a class="btn btn-theme-default" onclick="javascript:;notifyemail('<?php echo $product['name']; ?>','<?php echo $product['href']; ?>');" id="mainbtn" style="" title="Notify Me when In Stock"><em class="fa fa-envelope"></em><span>&nbsp;&nbsp;<?php //echo $sendmail_text; ?></span></a>
