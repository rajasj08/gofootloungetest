	...
	<section class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-12 col-xs-12">		
		<div id="content">
            ...
            <!--<div class="col-md-9 socialiconbunchcls">    
                               <div class="col-md-4"><a href="https://www.instagram.com/go_footlounge/"><img src="https://footlounge.in/image/social-icons/icon1.png" class="successicons" alt="FootLounge Instagram"/></a></div>
                               <div class="col-md-4"><a href="http://facebook.com/footlounge.online"><img src="https://footlounge.in/image/social-icons/icon2.png" class="successicons" alt="FootLounge Facebook"/></a></div>
                               <div class="col-md-4"><a href="https://twitter.com/go_footlounge"><img src="https://footlounge.in/image/social-icons/icon3.png" class="successicons" alt="FootLounge Twitter"/></a></div>
