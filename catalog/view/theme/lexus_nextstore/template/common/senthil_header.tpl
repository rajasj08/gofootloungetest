						...
						<div class="quick-access pull-left">
							...
							<div class="inner-toggle">
								<ul class="links">									
									...
									<!-- <li><a href="<?php echo $shopping_cart; ?>"><i class="fa fa-shopping-cart "></i><?php echo $text_shopping_cart_header; ?></a></li> -->
				...
				<div class="container">
					...
					<div class="right-cont">
						<div class="cart-mini-right">
							<div class="shopping-cart inner hidden-xs hidden-sm">
								<div class="cart-top">
									<?php echo $cart; ?>
								</div>
							</div>
						...
						<div class="search-left">
							<div class="login-register">
								...
								<div class="lr-text">
									<a href="account/login" title="Login">Login</a> or <br/ > <a href="account/register" title="Login">Register</a>
								</div>
							</div>
							<div id="search" class=" hidden-xs hidden-sm">
								...
								<div class="search_wrap">
									...
									<div class="sw_sub">
										<input id="button-searchd" class="button btn btn-theme-default" type="button" value="Go" onClick="return valids()">
									</div>
