		...
		<div class="container">
			...
			<div class="col-md-4 col-sm-12">
				<div class="shipping-cod-secure-payment-cont">
					<img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/shipping-cod-secure-payment.png">
				</div>
...
<img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/indian-rupee-symbol-icon.png" alt="cash on delivery">cash on delivery
</div>
<div class="col-sm-4">

<img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/100-percent-secure-icon.png" alt="secure shopping">Secure Shopping
</div>
<div class="col-sm-4">
<img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/free-shipping-icon.png" alt="free shipping">free shipping	
</div>
<div class="clear"></div>
</div>
<div class="clear"></div>
				...
				<div class="box customer-service">
					...
					<div class="box-content">
						<ul class="list">						  
							...
							<li><a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/Footlounge-Frequently-Asked-Questions">FAQ</a></li>
						</ul>
					</div>	
				</div>
			</div>
...
<p class="category-p"><a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/adidas-shoes-online" class="linklight">Adidas</a>&nbsp;/&nbsp;<a class="linklight" href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/reebok-shoes-online">Reebok</a>&nbsp;/&nbsp;<a class="linklight" href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/nike-shoes-online">Nike</a>&nbsp;/&nbsp;<a class="linklight" href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/american-tourister-travel-bags-online">American Tourister</a>&nbsp;/&nbsp;<a class="linklight" href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/fila-shoes-online">Fila</a>&nbsp;/&nbsp;<a class="linklight" href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/footlounge-sports-clothing-online">Foot Lounge</a>&nbsp;/&nbsp;<a class="linklight" href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/lee-cooper-shoes-online">Lee Cooper</a>&nbsp;/&nbsp;<a class="linklight" href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/puma-shoes-online">Puma</a></p>
</div>
</div>
		 <div class="col-xs-12"> 	
		 <div class="footext">
...
<p class="category-p"><a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men" class="linklight">Men</a>&nbsp;/&nbsp;<a class="linklight" href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/women">Women</a>&nbsp;/&nbsp;<a class="linklight" href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/kids">Kids</a>&nbsp;/&nbsp;<a class="linklight" href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/shoes">Sport Shoes</a>&nbsp;/&nbsp;<a class="linklight" href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/shoes/running-shoes">running Shoes</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/shoes/sports/tennis-shoes" class="linklight">Tennis Shoes</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/shoes/sports/cricket-shoes" class="linklight">Cricket Shoes</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/shoes/sports/football-shoes" class="linklight">Football Shoes</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/shoes/sports/basketball-shoes" class="linklight">Basketball Shoes</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/shoes/training-shoes" class="linklight">Training Shoes</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/women/shoes/walking-shoes" class="linklight">Walking Shoes</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/shoes/sandals-floaters" class="linklight">Floaters</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/women/shoes/flip-flops-slippers" class="linklight">Flip - Flops</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/shoes/sandals-floaters" class="linklight">Sandals</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/shoes/outdoor-hiking-shoes" class="linklight">Hiking Shoes</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/women/shoes/cardio-shoes" class="linklight">Cardio Shoes</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/women/shoes/dance-shoes" class="linklight">Dance Shoes</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/clothing" class="linklight">Sport Clothing</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/clothing/shorts" class="linklight">Sport Shorts</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/clothing/t-shirt" class="linklight">Sport T-Shirts</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/clothing/track-pants" class="linklight">Sports Track Pants</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/accessories/caps" class="linklight">Caps</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/accessories/wallet" class="linklight">Wallets</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/accessories/socks" class="linklight">Socks</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/accessories/headband" class="linklight">Headbands</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/accessories/backpack" class="linklight">Back Pack</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men/accessories/travel-bag" class="linklight">Travel Bag</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/fitness/yoga-mat" class="linklight">Yoga Mat</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/fitness/fitness-mat" class="linklight">Fitness Mat</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/fitness/resistance-tube" class="linklight">Resistance Tube</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/fitness/power-tube" class="linklight">power Tube</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/fitness/dumbells" class="linklight">Dumbbells</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/fitness/kettle-bells" class="linklight">Kettle Bells</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/fitness/ankle-weight" class="linklight">Weights</a>&nbsp;/&nbsp;<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/fitness/water-bottle" class="linklight">Bottle</a></p>
</div>	
...
<img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/downarrow.png" alt="footlounge">
...
We now provide the same great in-store shopping experience to our online community with our online shop-http://gofootlounge-env.ap-south-1.elasticbeanstalk.com. We offer the best deals and discounts for sports shoes, sports clothing and sports accessories. Explore our sports collections in Adidas Sale, Reebok Sale, and Nike Sale. 
...
<div class="footernstyle">Introducing Brand <img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/data/lo2logo.png" alt="Footlounge Logo" class="footerlogoimg"/></div>
...
<div class="mobilelastcol"><a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/terms-conditions">Terms &amp; Conditions</a> | <a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/privacy-policy-and-pisclaimer">Privacy Policy</a> | <a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/aboutus">About Us</a></div></div>
</div>	
