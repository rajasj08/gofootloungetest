...
<section id="content404" class="content404">
	<div class="container new_page_bor">
		<div class="fl_404_container">   
    
    <div tabindex="501" class="screenreader">
       <img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/catalog/view/theme/lexus_nextstore/image/page404/teamflcartoonshoes.png" class="new_page_imgwid" alt="Page 404">
    ...
    <p>The page you requested is no longer here.</p>
     ...
     <p class="screenreader1">It seems the page that you were trying to reach doesn't exist anymore, or it might have moved. See if the links below will help you get to where you need to go.</p></div>
      ...
      <div class="row brandrow">
						...
						<p></p><h4 class="new_page_fw">Category</h4><p></p>
							...
							<div class="inner">
								<ul>
									...
									<!---<li class="col-lg-12 col-sm-12 col-xs-12">
										<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/running-shoes">Top Brands</a>
										...
										<ul> -->
											...
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/men">Men</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/women">Women</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/kids">Kids</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/fitness">Fitness</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/apparel">Apparel</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/flip-flops">Flip Flops</a>
																							
											</li>

											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/lifestyle-sandals">LifeStyle Sandals</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/luggage-bags">Luggage Bags</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/running-shoes">Running Shoes</a>
     ...
     <div class="row brandrow">
						...
						<p></p><h4 class="new_page_fw">Brands</h4><p></p>
								...
								<ul>
									...
									<!---<li class="col-lg-12 col-sm-12 col-xs-12">
										...
										<ul> -->
											...
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/adidas-shoes-online">Adidas</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/reebok-shoes-online">Reebok</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/nike-shoes-online">Nike</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/american-tourister-travel-bags-online">American Tourister</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/fila-shoes-online">Fila</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/footlounge-sports-clothing-online">Foot Lounge</a>
																							
											</li>

											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/lee-cooper-shoes-online">Lee Cooper</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/puma-shoes-online">Puma</a>
		...
		<div class="row brandrow">
						...
						<p></p><h4 class="new_page_fw">Information</h4><p></p>
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
							<div class="inner">
								...
								<!---	<li class="col-lg-12 col-sm-12 col-xs-12">
										<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/running-shoes">Information</a>
									
										<ul> -->
											
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/about_us">About Us</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/delivery-information">Delivery Information</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/terms-conditions">Terms &amp; Conditions</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/privacy-policy-and-pisclaimer">Privacy Policy And Disclaimer</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/footlounge-return-policy">Return Policy</a>
		...
		<div class="row brandrow">
						...
						<p></p><h4 class="new_page_fw">Customer Service</h4><p></p>
							...
							<div class="inner">
								...
								<!---	<li class="col-lg-12 col-sm-12 col-xs-12">
										...
										<ul> -->
											...
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/contact">Contact Us</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/return">Returns</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/sitemap">Site Map</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/Footlounge-Frequently-Asked-Questions">FAQ</a>
...
Reebok </a></li>
    ...
    <div class="pagecontent">  
		...
		<p class="buttontext"><a href="mailto:i order@footlounge.in"><button type="button" class="emailbtn"><i class="glyphicon glyphicon-envelope"></i>&nbsp; Email Us</button></a> 
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body new_page_padd">
        	<form class="form-horizontal" id="feedbackform">
			  ...
			  <div class="form-group">
			    <label for="inputEmail3" class="col-sm-3">Your Name<span class="new_page_clr">*</span></label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control new_page_fs" id="username" placeholder="Enter Your Name">
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="inputEmail3" class="col-sm-3">Email<span class="new_page_clr">*</span></label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control new_page_fs" id="emailid" placeholder="Email"><span id="emailid_error" class="new_page_clr"></span>
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="inputEmail3" class="col-sm-3">Phone Number</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control new_page_fs" id="phoneno" placeholder="Phone Number"> 
			    </div>
			  </div>
	
			  
				<div class="form-group">
			    <label for="inputEmail3" class="col-sm-3">Product Name<span class="new_page_clr">*</span></label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control new_page_fs" id="productname" placeholder="Product Name">
			    </div>
			  </div>			
			  
			    <div class="form-group">
			    <label for="inputPassword3" class="col-sm-3">Comments<span class="new_page_clr">*</span></label>
			    <div class="col-sm-8">
			      <textarea class="form-control new_page_fs" id="comment" placeholder="Enter Your Comments" rows="5"></textarea>
			    </div>
			  </div>
     ...
     <span id="loadingspan" class="new_page_disp1"><img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/catalog/view/theme/lexus_nextstore/image/fb-loading.gif" alt="Loading"> </span>  
